...
The DB-touching resolvers (is_enabled, enabled_variant_names, variant_price)
are covered by integration behavior on a real site; here we pin the fallback
branching that decides "override vs inherit", which is exactly where a
regression would silently push the wrong title/description.
"""
